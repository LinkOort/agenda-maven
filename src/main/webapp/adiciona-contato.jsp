		...
		<div class="card">
			<div class="card-body">
				<form action="cadastra-usuario" id="form-produto">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="nome">Nome</label> <input type="text"
								value="${param.nome}" class="form-control" id="name" name="nome"
								placeholder="Nome">
						</div>
						<div class="form-group col-md-3">
							<label for="data">Data de Nacimento</label> <input type="date"
								value="" class="form-control" id="data" name="data"
								placeholder="Data de Nascimento">
						</div>
						<div class="form-group col-md-3">
							<label for="cpf">CPF</label> <input type="text" value=""
					...
					<div class="form-row">
						<div class="form-group col-md-3">
							<label for="inputState">Sexo</label> <select id="inputState"
								class="form-control">
						...
						<div class="form-group col-md-3">
							<label for="tel">Telefone</label> <input type="text"
								value="${param.telefone}" class="form-control" id="tel"
								name="telefone" placeholder="Telefone" data-mask="(99)9999-9999">
						</div>
						...
						<div class="form-group col-md-3">
							<label for="end">Endereço</label> <input type="text"
								value="${param.endereco}" class="form-control" id="end"
					...
					<div class="form-row">
						<div class="form-group col-md-3">
							<label for="cep">CEP</label> <input type="text" value=""
								class="form-control" id="cep" name="cep" placeholder="CEP"
								data-mask="99999-999">
						</div>
					</div>
